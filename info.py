...
DATABASE_NAME = environ.get('DATABASE_NAME', "teluguzonebots")
...
URL = "https://danny-ozve.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://danny-ozve.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://danny-ozve.onrender.com/".format(FQDN)
else:
    URL = "https://danny-ozve.onrender.com/".format(FQDN)
